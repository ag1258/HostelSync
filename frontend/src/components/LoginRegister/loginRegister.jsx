            ...
            <div className="logMain">
                ...
                <div class="form-logContainer sign-up">
                    <form onSubmit={handleSignUp}>
                        ...
                        <input type='text'name ="enrollmentID" id='enrollmentID' onChange={handleChange} value={formData.enrollmentID} placeholder='Enrollment ID'/>
                ...
                <div class="form-logContainer sign-in">
                    <form onSubmit={handleSignIn}>
                        <h1>Sign In</h1>
                        <input type="text" name ="enrollmentID" id='enrollmentID' onChange={handleChangeAgain} value={loginData.enrollmentID} placeholder="Enrollment ID"/>
