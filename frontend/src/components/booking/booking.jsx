                                ...
                                <div className="flex flex-col gap-4 justify-between">
                                    <div className="flex items-center gap-2">
                                        <select
                                            ...
                                            <option value="Attach Bathroom Non AC">Attach Bathroom Non AC</option>
                                            <option value="Common Bathroom Non AC">Common Bathroom Non AC</option>
                                            <option value="Attach Bathroom With AC">Attach Bathroom With AC</option>
                                            <option value="Common Bathroom With AC">Common Bathroom With AC</option>
                                        </select>
                                        <select
                                            name="hostelname"
                                            className="border-black flex-1 border-solid border-[2px] p-5 rounded-2xl"
                                            ...
                                            {hostelNames[formData.gender]?.[formData.roomtype]?.map((hostel, index) => (
