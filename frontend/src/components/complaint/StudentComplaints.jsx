...
const StudentComplaints = () => {
    ...
    useEffect(() => {
        const fetchComplaints = async () => {
            ...
            setError('');
            try {
                const response = await axios.get('http://localhost:3005/complaints/student', { withCredentials: true });
        ...
        <>
            ...
            <div className="sticky w-[500px] min-h-[300px] mx-[100px]">
                ...
                <div>
                    ...
                    {loading && <div className="text-center text-blue-600 mt-5">Loading complaints...</div>}
                    ...
                    {complaints.length > 0 ? (
                            ...
                            >
                                ...
                                <div className="right-side w-full md:w-1/2 flex flex-col items-center justify-center md:items-end leading-[3]">
                                    <p>
                                        ...
                                        <span className={`${getStatusStyle(complaint.status)} font-semibold`}>
                                            {complaint.status}
                                        </span>
                                    </p>
                                </div>
                        ...
                        !loading && !error && <div className="text-center text-gray-500 mt-5">No complaints found.</div>
                    )}
                </div>
            </div>
            <Footer />
